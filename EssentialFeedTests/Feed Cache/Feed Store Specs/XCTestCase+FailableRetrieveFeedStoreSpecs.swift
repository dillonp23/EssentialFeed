...
extension FailableRetrieveFeedStoreSpecs where Self: CodableFeedStoreTests {
...
extension FailableRetrieveFeedStoreSpecs where Self: CoreDataFeedStoreTests {
    func assertRetrieveDeliversFailureOnFailedRetrieval(usingStore sut: FeedStore,
                                                        file: StaticString = #filePath, line: UInt = #line) {
        expect(sut, toCompleteRetrievalWith: .failure(anyNSError()), file: file, line: line)
    }
}
